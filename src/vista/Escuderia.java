...
public class Escuderia extends JFrame {
	...
	public Escuderia() {
		...
		btnNewButton.setBounds(350, 332, 261, 125);
		...
		btnPilotos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Piloto piloto = new Piloto();
				piloto.setBounds(100, 100, 865, 650);
				piloto.setLocationRelativeTo(null);
				piloto.setDefaultCloseOperation(EXIT_ON_CLOSE);
