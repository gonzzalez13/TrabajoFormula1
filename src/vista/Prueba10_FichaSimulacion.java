...
public class Prueba10_FichaSimulacion extends JFrame {
	...
	private JTextField txtEscuderia,txtPiloto,txtVueltaRapida;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Prueba10_FichaSimulacion frame = new Prueba10_FichaSimulacion();
	 ...
	 * Create the frame.
	 */
	public Prueba10_FichaSimulacion() {
this.setIconImage(Toolkit.getDefaultToolkit().getImage(Noticia2.class.getResource("/Imagenes/F1-logo-ventana.png")));
	 ...
	 */
		...
		//LabelCircuito.setIcon(new ImageIcon("src"+File.separator+"Imagenes"+File.separator+"Grandes Premios"+File.separator+"Circuitos"+File.separator+this.getComboListaCircuitos().getSelectedItem().toString()+".png"));
